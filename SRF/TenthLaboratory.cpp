...
std::vector<Mat> TenthLaboratory::computeParams(const char* filename)
{
    ...
    //{
    //    auto redTuple = red.at(i);
    //    redPoints.at<float>(i, 0) = std::get<0>(redTuple);
    //    redPoints.at<float>(i, 1) = std::get<1>(redTuple);
    //    redPoints.at<float>(i, 2) = std::get<2>(redTuple);
    //}

    //for (int i = 0; i < blue.size(); ++i)
    //{
    //    auto blueTuple = blue.at(i);
    //    bluePoints.at<float>(i, 0) = std::get<0>(blueTuple);
    //    bluePoints.at<float>(i, 1) = std::get<1>(blueTuple);
    //    bluePoints.at<float>(i, 2) = std::get<2>(blueTuple);
    //}
    //trainSet.push_back(redPoints);
    //trainSet.push_back(bluePoints);
